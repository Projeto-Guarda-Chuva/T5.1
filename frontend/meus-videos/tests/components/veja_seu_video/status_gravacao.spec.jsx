...
describe("Aplicação Veja seu Vídeo - Status de Gravação", () => {
  ...
  it("usa a mensagem genérica quando a falha não traz detail da API", async () => {
    marcarQueVaiParticiparMock.mockRejectedValue(new Error("network down"));
    ...
    const caseLog = registerCase({
      ...
      expected: {
        alert: "Erro ao registrar status. Tente novamente.",
      },
    });
