...
@pytest.mark.asyncio
async def test_create_configuration_route_should_reject_whitespace_only_text_fields(
    monkeypatch,
    case_log,
) -> None:
    payload = {
    ...
    case_log["notes"] = [
        "Contrato esperado: campos textuais obrigatórios não devem aceitar apenas espaços em branco.",
    ]
